...
from accounts.views.send_otp import SendOTP, SendUpdateOTP, SendEmailOTP, EmailSendOTP
from accounts.views.verify_otp import VerifyOTP, VerifyAndUpdatePhoneNumber, VerifyEmailOTP, EmailVerifyOTP
