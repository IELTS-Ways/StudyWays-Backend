...
from subscription.wallet_pay import CheckWallet, CheckWalletAndPay, WalletAndBOGOPay, WalletAndBOGOAutoPay
...
urlpatterns = [
    ...
    path("auto-wallet-bogo-pay", WalletAndBOGOAutoPay.as_view(), name="auto-wallet-bogo-pay"),
    #
