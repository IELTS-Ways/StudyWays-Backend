...
from subscription.views import StudentSubs, AddSub, AddSubPay, SubPayVerify, Membership, WithdrawRequest, BOGOVerify
...
urlpatterns = [
    ...
    path("BOGO-verify/<int:id>/",SubPayVerify.as_view(),name="BOGO-verify"),
    #
